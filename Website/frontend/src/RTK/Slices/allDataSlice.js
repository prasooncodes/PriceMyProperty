...
import { fetchAllData } from '../../RTK/Slices/allDataSlice'; // Only import what exists
import './AllFlats.css';

const AllFlats = () => {
  const dispatch = useDispatch();
  const { data, loading, error, totalPages } = useSelector((state) => state.allData);
  ...
  const handleAddToCart = (flat) => {
    ...
    console.log('Added to cart:', flat);
    alert(`Added ${flat.SOCIETY_NAME} to cart!`);
  };
